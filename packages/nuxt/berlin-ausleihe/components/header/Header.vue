<template>
  <header
    class="relative z-20 w-full h-[70px] flex flex-wrap items-center justify-between px-6"
  >
    <NuxtLinkLocale :to="{ name: 'resources' }">
      <div class="flex items-center gap-2.5">
        <svg
          ...
          aria-hidden="true"
        >
          <use href="/illustrations/ausleihe.svg#fragment" />
        </svg>

        <span class="text-2lg font-normal hidden sm:inline">
          ausleihe<span class="font-semibold">.engagiertes.berlin</span>
        </span>
      </div>
    </NuxtLinkLocale>
